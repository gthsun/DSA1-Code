...
public static int NUM_TESTS = 5000;
	...
	public static void main(String[] args) {
		...
		vector.Vector<Integer> cool = new vector.Vector<Integer>(5);
		for(int i = 0; i < cool.capacity(); i++){
			cool.insertAtTail(i);
		}
		cool.insertAtTail(99);
		cool.insertAtHead(11);
		cool.insertAt(4, 55);
		cool.insertAt(12, 39);
		cool.insertAt(cool.size(), 101);
