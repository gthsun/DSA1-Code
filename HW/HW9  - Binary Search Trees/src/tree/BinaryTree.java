...
public class BinaryTree<T> {
    ...
    //Equals method - Checks if two instances of a BinaryTree are equal to each other
    public boolean equals(Object o){
        if(o == null) return false; //Null check
        else if(o == this) return true; //Aliases are equal
        else if(o instanceof BinaryTree<?>){ //If parameter is an instance of a BinaryTree
            BinaryTree<T> t = (BinaryTree<T>) o;
            return this.getInOrder().equals(t.getInOrder()) && //Check if traversals are the same
                    this.getPreOrder().equals(t.getPreOrder()) &&
                    this.getPostOrder().equals(t.getPostOrder());
        }
